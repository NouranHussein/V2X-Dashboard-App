...
public class BluetoothConnectionService implements Parcelable {
    ...
    protected BluetoothConnectionService(Parcel in) {
        mmDevice = in.readParcelable(BluetoothDevice.class.getClassLoader());
    }

    public static final Creator<BluetoothConnectionService> CREATOR = new Creator<BluetoothConnectionService>() {
        @Override
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeParcelable(mmDevice, flags);
    }
        ...
        public void run(){
            ...
            while (true) {
                ...
                try {
                    ...
                    incomingIntent.putExtra("msg",incomingMessage);
